...
Implementation is original; product attribution is maintained in references.md. Public references: Microsoft Windows.Media.Control documentation and https://lrclib.net/docs.
